...
@RestController
@RequestMapping("/api/xinghaokf-application-kafka")
public class XinghaokfApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(XinghaokfApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public XinghaokfApplicationKafkaResource(KafkaProperties kafkaProperties) {
